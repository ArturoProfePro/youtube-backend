...
class CoreProvider(Provider):
    ...
    @provide(scope=Scope.APP)
    @staticmethod
    async def get_auth_settings(settings_repository: SettingsRepositoryProtocol) -> CoreAuthSettingsSchema:
        """
        Get cache settings.
        """
        return await settings_repository.get(CoreAuthSettingsSchema)

    @provide(scope=Scope.APP)
    @staticmethod
    async def get_verify_settings(
        settings_repository: SettingsRepositoryProtocol,
    ) -> CoreVerificationSettingsSchema:
        """
        Get cache settings.
        """
        return await settings_repository.get(CoreVerificationSettingsSchema)
    ...
    async def get_email_settings(
        ...
        Get cache settings.
        """
        return await settings_repository.get(CoreEmailSettingsSchema)
