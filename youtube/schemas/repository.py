...
class CreateSchemaGeneric(BaseSchema, Generic[IdType]):
    """
...
class ReadSchemaGeneric(BaseSchema, Generic[IdType]):
    """
...
class UpdateSchemaGeneric(BaseSchema, Generic[IdType]):
    """
